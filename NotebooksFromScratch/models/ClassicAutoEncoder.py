...
class ClassicAutoEncoder():
    ...
    def _build(self):
        ...
        encoder_output = Dense(self.latent_dim, name="encoder_output")(layer)
        ...
        def reconstruction_loss(y_pred, y_true):
            return mean(square(y_pred - y_true), axis=[1, 2, 3])
    ...
    def compile(self, learning_rate):
        ...
        self.autoencoder_model.compile(optimizer=optimizer, loss=self.reconstruction_loss)
